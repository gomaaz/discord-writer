...
**📸 [See what it produces — eight showcases, rendered in a real Discord client](showcases/README.md)**

---

## See it in action

Every showcase below is real output pasted into Discord and screenshotted — input, the exact text to paste, and the render. Nothing here is a mockup.

| [01 · One post, six formats](showcases/README.md#01--one-post-six-formats) | [02 · Screen priority](showcases/README.md#02--screen-priority) | [03 · Color that survives copy/paste](showcases/README.md#03--color-that-survives-copypaste) | [04 · Before and after](showcases/README.md#04--before-and-after) |
|---|---|---|---|
| [![Heading, prose, change list, diff, callout and timestamp in one message](showcases/images/01-hybrid-post.png)](showcases/README.md#01--one-post-six-formats) | [![Four-column table on desktop](showcases/images/02a-table-desktop.png)](showcases/README.md#02--screen-priority) | [![diff block rendering red and green](showcases/images/03-diff.png)](showcases/README.md#03--color-that-survives-copypaste) | [![Change card with before and after](showcases/images/04-change-card.png)](showcases/README.md#04--before-and-after) |

| [05 · Timestamps that adapt](showcases/README.md#05--timestamps-that-adapt-to-the-reader) | [06 · Release notes](showcases/README.md#06--release-notes) | [07 · Live status](showcases/README.md#07--live-status) | [08 · Long changes](showcases/README.md#08--long-changes) |
|---|---|---|---|
| [![Metadata block with rendered timestamps](showcases/images/05-timestamps.png)](showcases/README.md#05--timestamps-that-adapt-to-the-reader) | [![Changelog categories rendered in Discord](showcases/images/06-changelog.png)](showcases/README.md#06--release-notes) | [![Status list with colored dots and text](showcases/images/07-status-list.png)](showcases/README.md#07--live-status) | [![Hanging change and warning callout on a phone](showcases/images/08-hanging-callout.png)](showcases/README.md#08--long-changes) |

**→ [Open the showcase gallery](showcases/README.md)** — every one of them with its rough input, the raw text to copy, and why that layout.
...
**→ [The other six showcases](showcases/README.md)**: `diff` color, before/after cards, reader-local timestamps, changelog categories, status lists and hanging changes — each with the raw text to paste and a screenshot of the result.
...
Most of that list is in the **[showcase gallery](showcases/README.md)** as a rendered screenshot rather than a description.
...
└── rules/                   # dropped-in rule sources, kept as origin record
```

The root is a closed set: `SKILL.md` has to sit there for the plugin mechanism, the rest are repository conventions and the two contributor entry points. Everything new goes into one of the folders.
...
`SKILL.md` is the canonical source of behavior. There is no build step and no test runner; § 18 of `SKILL.md` holds the regression cases R1–R15 that should be re-checked after substantial changes.
