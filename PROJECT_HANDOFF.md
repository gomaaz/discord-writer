...
The project reached version **1.5** through iterative real-world Discord rendering tests on desktop and mobile. As of 1.5 the specification and all templates/examples are English-only; output language still follows the user.
